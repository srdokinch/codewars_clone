...
const ADVANCED_SPLASH_MESSAGES: Record<number, AdvancedSplashMessage> = {
  1: {
    title: "★ 応用問題だ！",
    body: "console.log も変数もお馴染みのはず。\nここからは「自分の言葉」で語る番です！",
  },
  2: {
    title: "★ 型と演算、応用！",
    body: "数値も文字列もいじれるようになったあなたへ。\n計算はだいたい合ってればOK！",
  },
  3: {
    title: "★ if文の本番！",
    body: "条件分岐マスターへの最終関門。\nここを抜けたら分岐は怖くない！",
  ...
  4: {
    title: "★ 配列、応用モード！",
    body: "for文とメソッドを組み合わせる番。\nリスト表示の一歩先へ！",
  },
  5: {
    title: "★ 関数、応用モード！",
    body: "関数を「作って使う」側に回る時間。\n再利用の達人気分でいこう！",
  },
  6: {
    title: "★ オブジェクト応用！",
    body: "キーと値の組み合わせ遊びの本番。\nJSONの気分でいじってみよ！",
  },
  7: {
    title: "★ map/filter の応用！",
    body: "React で使うやつ、ここで握ろう。\n配列を好きになったら半分勝ち！",
  },
  8: {
    title: "★ DOM、直接いじるぞ！",
    body: "HTMLコーダーの本領発揮タイム。\nブラウザを動かす側に回ろう！",
  },
  9: {
    title: "★ 非同期、応用だ！",
    body: "待つのが苦手でも大丈夫。\nPromise はちゃんと待ってくれる！",
